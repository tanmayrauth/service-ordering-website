...
$query = mysqli_query($connection, $users);
if ($query === TRUE) {
...
////////////////////////////////////
$useroptions = "CREATE TABLE IF NOT EXISTS useroptions ( 
                id INT(11) NOT NULL,
                username VARCHAR(16) NOT NULL,
...
$query = mysqli_query($connection, $useroptions); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $friends); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $blockedusers); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $status); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $photos); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $notifications); 
if ($query === TRUE) {
