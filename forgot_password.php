...
function forgotpass(){
	var e = _("email").value;
	if(e == ""){
		_("f_status").innerHTML = "Type in your email address";
	} else {
		_("forgotpassbtn").style.display = "none";
		_("f_status").innerHTML = 'please wait ...';
        ...
        ajax.onreadystatechange = function() {
	        if(ajaxReturn(ajax) == true) {
				...
				if(response == "success"){
					...
					_("f_status").innerHTML = "Sorry that email address is not in our system";
				} else if(response == "email_send_failed"){
					_("f_status").innerHTML = "Mail function failed to execute";
				} else {
					_("f_status").innerHTML = "An unknown error occurred";
				}
	        }
        }
        ajax.send("e="+e);
...
<div id="pageMiddle" align="center" class="container" style="height:500px; ">
  ...
  <form id="forgotpassform" onsubmit="return false;">
    ...
    <input id="email" type="text" onfocus="_('f_status').innerHTML='';" maxlength="88">
    <br /><br />
